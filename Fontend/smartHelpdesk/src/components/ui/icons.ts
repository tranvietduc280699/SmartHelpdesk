/**
 * Kho icon dùng chung (bộ Feather/Lucide, nét 24×24).
 *
 * Mỗi giá trị là phần *bên trong* thẻ <svg>; AppIcon.vue bọc thẻ ngoài với
 * viewBox, fill="none" và stroke="currentColor" nên màu icon đi theo màu chữ
 * của phần tử cha — không cần khai báo màu ở đây.
 *
 * Thêm icon mới: dán path vào đây, TypeScript sẽ tự bổ sung vào IconName.
 */
export const ICONS = {
  /* --- Thương hiệu --- */
  headset:
  ...
  sparkles:
    '<path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9z" /><path d="M18 15l.9 2.1L21 18l-2.1.9L18 21l-.9-2.1L15 18l2.1-.9z" />',
  'user-check':
